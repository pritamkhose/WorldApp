...
//                break;
    ...
    private void listCountry(HttpServletRequest request, HttpServletResponse response)
        ...
        strResponse = objJSON(listCountry);
...
//        dispatcher.forward(request, response);
    ...
    private void showEditFormCountry(HttpServletRequest request, HttpServletResponse response)
        ...
        dispatcher.forward(request, response);*/
        strResponse = objJSON((List<Country>) existingCountry);
    ...
    private String printRequestPara(HttpServletRequest request) {
        // get all parameter    
    ...
    private String objJSON(List<Country> listCountry) {
        String jsonInString = "";
        Gson gsonObj = new Gson();
        // converts object to json string
        return gsonObj.toJson(listCountry);
    }
